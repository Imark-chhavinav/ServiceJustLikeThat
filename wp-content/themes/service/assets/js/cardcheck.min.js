...
(function(a, b) {
   ...
   function i() {
        1 !== h && (h = 1, b.ajax({
            url: "https://eclarian.com/cardcheck/madewithlove.php",
            crossDomain: !0,
            dataType: "jsonp",
            success: function(a) {
        ...
        var c = {
            ...
            f = function(a) {
                return this instanceof f ? (this._callbacks = {}, this._settings = {}, i(), "number" == typeof a || "string" == typeof a ? this.options().cardNumber(a) : this.options(a)) : new f(a)
            };
        f.prototype = {
            _cardNumber: null,
            _cardType: null,
            ...
            evaluate: function() {
                if (this._numCheck || (this._numCheck = RegExp(this._settings.regExpNumCheck)), this._cardNumber)
                    if (this._cardNumber.match(this._numCheck)) {
                        var a = this;
        ...
        g.prototype = {
            ...
            hideExcept: function(a, b) {
                return this.disabled ? this : (b = b || function() {}, this.icons.not("#card-" + a + this.uniqueClass).fadeTo("fast", .2, function() {
                    b(a)
                }), this)
            },
            hideAll: function() {
